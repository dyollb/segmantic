...
def cross_validate(
    ...
    number of folds are defined in the config file generated by
     ...
     cross-validate -c my_crossval_configs.yml --print-defaults.
    ...
    config_files
        |   |   |
        |   |   train_config_no_augmentation.yml
        |   train_config_w_spatial.yml
        train_config_w_intensity.yml

    After placing and editing all the config-files accordingly, start the process using

    segmantic-unet cross-validate -c 'path/to/my_crossval_configs.yml'
...
def predict(
    ...
    Example invocation:
        ...
        -d ./datalist.json -m model.ckpt --results-dir ./results
    """
