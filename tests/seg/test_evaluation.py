...
def test_confusion_matrix():
    labelfield = make_itk_image(shape=(10, 10), spacing=(1.0, 1.0), value=0)
...
def test_hausdorff():
    labelfield = make_itk_image(shape=(10, 10), spacing=(1.0, 1.0))
    ...
    labelfield2 = make_itk_image(shape=(10, 10), spacing=(1.0, 1.0))
