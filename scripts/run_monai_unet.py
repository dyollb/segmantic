...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--image_dir', dest='image_dir', type=Path, required=True, help='image directory')
    parser.add_argument('-l', '--labels_dir', dest='labels_dir', type=Path, help='label image directory')
    parser.add_argument('-o', '--results_dir', dest='results_dir', default='.', type=str, help='results directory')
    parser.add_argument('--tissue_list', type=Path, required=True, help='file containing label descriptors')
